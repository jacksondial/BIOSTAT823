...
\begin{bmatrix}
-\frac{2}{2\sigma^2}[\sum_{i=1}^ny_i  - n\alpha + \beta\sum_{i=1}^nx_i]
\\ 
-\frac{2}{2\sigma^2}[ \beta\sum_{i=1}^nx_i^2 +\alpha\sum_{i=1}^n-\sum_{i=1}^nx_iy_i]
\\
-\frac{n}{-2\sigma^2}+\frac{\sum_{i=1}^n (y_i-\alpha-\beta x_i)^2}{2\sigma^4}
\end{bmatrix}
$$
